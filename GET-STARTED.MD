...
# Steps on Ubuntu 22.04 (Suggest doing this in a VM with root privileges)
...
- ESPUP
  ...
  # echo "source $HOME/export-esp.sh" >> /etc/profile.d/espup.sh
  ```
- New Project: https://github.com/esp-rs/esp-idf-template#generate-the-project
  ```shell
